	...
	namespace Fbx {
		...
		public ref class FbxLoader {
			...
			private:
				...
				void IterateChildren		( FbxNode *fbxNode, FbxScene *fbxScene, Graphics::Scene ^scene, int parentIndex );
				...
				void GetCustomProperties	( Graphics::Node ^node, FbxNode *fbxNode );
