...
namespace InstancingDemo2 {
	class InstancingDemo2 : Game {
		...
		void InstancingDemo2_Reloading ( object sender, EventArgs e )
		{
			...
			factory		=	new StateFactory( GraphicsDevice, typeof(UberFlags), us, VertexInputElement.FromStructure<VertexInstance>(), BlendState.Additive, RasterizerState.CullNone );
		...
		protected override void Draw ( GameTime gameTime, StereoEye stereoEye )
		{
			...
			GraphicsDevice.SetupVertexInput( null, new[]{ vb, vbi }, new[]{0,0} );
