...
//			infectMap	= Game.GraphicsDevice.CreateDynamicTexture(mapDim, mapDim);
			...
			heatMap		= new Texture2D( Game.GraphicsDevice, mapDim, mapDim, ColorFormat.Rgb32F, false );
			infectMap	= new Texture2D( Game.GraphicsDevice, mapDim, mapDim, ColorFormat.Dxt1, false );
		...
		public void SetHeatMapCoordinates(double left, double right, double top, double bottom)
		{
			...
			GenerateTileGrid(10, out heatVB, out heatIB, lt.X, rb.X, lt.Y, rb.Y);
		}
