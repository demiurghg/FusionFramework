...
namespace Fusion.GIS.LayerSpace.Layers
{
	...
	//		contourBuildingsVB = Game.GraphicsDevice.CreateVertexBuffer(typeof (GeoVert), contourBuildings.Length);
	...
	//		simpleBuildingsVB = Game.GraphicsDevice.CreateVertexBuffer(typeof(GeoVert), simpleBuildings.Length);
	...
	//		buildingsVB = Game.GraphicsDevice.CreateVertexBuffer(typeof(GeoVert), buildings.Length);
