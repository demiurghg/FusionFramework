...
#pragma warning disable 612, 168
...
namespace Fusion.GIS.MapSources
{
	public abstract class BaseMapSource
	{
		...
		void respCallback( IAsyncResult asyncResult )
		{
			...
			System.Drawing.Bitmap bitmap = new System.Drawing.Bitmap(reqState.Response.GetResponseStream());
			bitmap.Save(reqState.Path, System.Drawing.Imaging.ImageFormat.Jpeg);
		}



		public bool DownloadTileAsync( MapTile tile )
		{
			try {
				...
				reqState.Path		= tile.Path;

				IAsyncResult asyncResult	= request.BeginGetResponse( new AsyncCallback(respCallback), reqState );
