...
namespace Fusion.Mathematics
{
    ...
    {
        /// <summary>
        /// The size of the <see cref = "Byte4" /> type, in bytes.
        /// </summary>
        public static readonly int SizeInBytes = Marshal.SizeOf(typeof (Byte4));

        /// <summary>
        /// A <see cref = "Byte4" /> with all of its components set to zero.
        /// </summary>
        public static readonly Byte4 Zero = new Byte4();

        /// <summary>
        /// The X unit <see cref = "Byte4" /> (1, 0, 0, 0).
        /// </summary>
        public static readonly Byte4 UnitX = new Byte4(1, 0, 0, 0);

        /// <summary>
        /// The Y unit <see cref = "Byte4" /> (0, 1, 0, 0).
        /// </summary>
        public static readonly Byte4 UnitY = new Byte4(0, 1, 0, 0);

        /// <summary>
        /// The Z unit <see cref = "Byte4" /> (0, 0, 1, 0).
        /// </summary>
        public static readonly Byte4 UnitZ = new Byte4(0, 0, 1, 0);

        /// <summary>
        /// The W unit <see cref = "Byte4" /> (0, 0, 0, 1).
        /// </summary>
        public static readonly Byte4 UnitW = new Byte4(0, 0, 0, 1);

        /// <summary>
        /// A <see cref = "Byte4" /> with all of its components set to one.
        /// </summary>
        ...
        public Byte4(byte[] values)
        {
            ...
            if (values.Length != 4)
                throw new ArgumentOutOfRangeException("values",
                                                      "There must be four and only four input values for Byte4.");
        ...
        {
            result = new Byte4(left.X + right.X, left.Y + right.Y, left.Z + right.Z, left.W + right.W);
        }
        ...
        public static void Multiply(ref Byte4 value, int scale, out Byte4 result)
        {
            result = new Byte4(value.X*scale, value.Y*scale, value.Z*scale, value.W*scale);
        }
        ...
        public static Byte4 Multiply(Byte4 value, int scale)
        {
            return new Byte4(value.X*scale, value.Y*scale, value.Z*scale, value.W*scale);
        }
        ...
        public static void Modulate(ref Byte4 left, ref Byte4 right, out Byte4 result)
        {
            result = new Byte4(left.X*right.X, left.Y*right.Y, left.Z*right.Z, left.W*right.W);
        }
        ...
        public static Byte4 Modulate(Byte4 left, Byte4 right)
        {
            return new Byte4(left.X*right.X, left.Y*right.Y, left.Z*right.Z, left.W*right.W);
        }
        ...
        /// <param name = "scale">The amount by which to scale the vector.</param>
        /// <param name = "result">When the method completes, contains the scaled vector.</param>
        public static void Divide(ref Byte4 value, int scale, out Byte4 result)
        {
            result = new Byte4(value.X/scale, value.Y/scale, value.Z/scale, value.W/scale);
        }
        ...
        /// <param name = "scale">The amount by which to scale the vector.</param>
        /// <returns>The scaled vector.</returns>
        public static Byte4 Divide(Byte4 value, int scale)
        {
            return new Byte4(value.X/scale, value.Y/scale, value.Z/scale, value.W/scale);
        }
        ...
        public static void Negate(ref Byte4 value, out Byte4 result)
        {
            result = new Byte4(-value.X, -value.Y, -value.Z, -value.W);
        }
        ...
        public static Byte4 Negate(Byte4 value)
        {
        ...
        /// <param name = "scale">The amount by which to scale the vector.</param>
        /// <returns>The scaled vector.</returns>
        public static Byte4 operator *(int scale, Byte4 value)
        {
            return new Byte4(value.X*scale, value.Y*scale, value.Z*scale, value.W*scale);
        }
        ...
        /// <param name = "scale">The amount by which to scale the vector.</param>
        /// <returns>The scaled vector.</returns>
        public static Byte4 operator *(Byte4 value, int scale)
        {
            return new Byte4(value.X*scale, value.Y*scale, value.Z*scale, value.W*scale);
        }
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref = "Byte4" /> to <see cref = "Vector2" />.
        /// </summary>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref = "Byte4" /> to <see cref = "Vector3" />.
        /// </summary>
        /// <param name = "value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        ...
        /// <summary>
        /// Performs an explicit conversion from <see cref = "Byte4" /> to <see cref = "Vector4" />.
        /// </summary>
        /// <param name = "value">The value.</param>
        /// <returns>The result of the conversion.</returns>
        public static explicit operator Vector4(Byte4 value)
        {
        ...
        public override bool Equals(object value)
        {
            ...
            if (!ReferenceEquals(value.GetType(), typeof(Byte4)))
                return false;

            return Equals((Byte4) value);
        }

        /// <summary>
        /// Performs an implicit conversion from <see cref="int"/> array to <see cref="Byte4"/>.
        /// </summary>
        /// <param name="input">The input.</param>
        /// <returns>The result of the conversion.</returns>
        public static implicit operator Byte4(byte[] input)
        {
            return new Byte4(input);
        }

        /// <summary>
        /// Performs an implicit conversion from <see cref="Byte4"/> to <see cref="System.Int32"/> array.
        /// </summary>
        /// <param name="input">The input.</param>
        /// <returns>The result of the conversion.</returns>
        public static implicit operator byte[](Byte4 input)
        {
